...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/media/logos/logo-sm.png') }}" />
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="separator my-2"></div>
                                    <div class="menu-item px-5">
                                        <a href="{{ route('setting') }}" class="menu-link px-5">
                                            <span class="menu-icon">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="svg-icon svg-icon-3">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        ...
                                                        <rect opacity="0.3" width="12" height="2"
                                                            rx="1" transform="matrix(-1 0 0 1 15.5 11)"
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-8 d-flex align-items-center justify-content-center" id="kt_app_sidebar_logo">
